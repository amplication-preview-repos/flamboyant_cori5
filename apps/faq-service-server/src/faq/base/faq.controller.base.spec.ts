  ...
  test("POST /faqs", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        changed: CREATE_RESULT.changed.toISOString(),
      });
  });
      ...
      .expect([
        {
          ...
          changed: FIND_MANY_RESULT[0].changed.toISOString(),
        },
      ]);
  });
  ...
  test("GET /faqs/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        changed: FIND_ONE_RESULT.changed.toISOString(),
      });
  });
